...
let prestataires = [
    {"uuid":"720bd6fd-a0bb-4edd-b93b-0fde5535526e", "societe":"Burger King","adresse": "3 rue de Japy", "email":"burgerking@gmail.com", "password":"mdp123","theme":"Alimentation", "description":"Pour le Creepy Night Festival, nous avons revisité nos classiques avec une touche effrayante ! Des recettes revisitées aux couleurs de l’horreur, des saveurs audacieuses et une ambiance qui fait frissonner. Oserez-vous y goûter ?", "logo": require("../assets/logo_burgerking.png"), "background": require("../assets/background_BK.jpg"), "background2": require("../assets/background2_BK.jpg")},
    {"uuid":"3e867994-2cbb-4c14-8069-8797e1b5b9b0", "societe":"POP","adresse": "5 rue de Belfort", "email":"pop@gmail.com", "password":"mdp123","theme":"Goodies", "description":"Les icônes de l’horreur prennent vie dans notre collection spéciale Creepy Night ! Retrouvez vos personnages cultes sous forme de figurines, dans des éditions effrayantes et exclusives. Une touche de frisson à collectionner !", "logo": require("../assets/logo_pop.png"), "background": require("../assets/background_POP.jpg"), "background2": require("../assets/background2_POP.jpg")},
    {"uuid":"48db5207-95bd-460e-9f9b-a915e18577a6", "societe":"Starybucks","adresse": "22 place de la République", "email":"starbucks@gmail.com", "password":"mdp123","theme":"Alimentation","description":"Plongez dans un univers ensorcelé avec nos boissons aux notes mystérieuses et envoûtantes. Entre saveurs automnales et créations surprises, chaque gorgée vous emmène dans l’ambiance inquiétante du festival.", "logo": require("../assets/logo_starbucks.png"), "background": require("../assets/background_starbucks.jpg"), "background2": require("../assets/background2_starbucks.jpg")},
    {"uuid":"3eafe64c-4c88-43d4-b454-720c3431d113", "societe":"Domino's Pizza","adresse": "45 boulevard Haussmann", "email":"dominos@gmail.com", "password":"mdp123","theme":"Alimentation", "description":"Nos recettes prennent une allure terrifiante pour l’occasion ! Des ingrédients surprenants, des associations audacieuses et une touche infernale dans chaque bouchée. Préparez-vous à une expérience gustative hors du commun","logo": require("../assets/logo_domino.png"), "background": require("../assets/background_DominosPizza.jpg"), "background2": require("../assets/background2_DominosPizza.jpg")},
    {"uuid":"0be0404c-dba2-4efa-9497-a8692c97a312", "societe":"Ricard","adresse": "8 rue du Commerce", "email":"ricard@gmail.com", "password":"mdp123","theme":"Boisson", "description":"Nos créations inédites pour le festival vous feront frissonner de plaisir. Des associations surprenantes, des couleurs sombres et un goût inimitable pour accompagner cette nuit d’épouvante","logo": require("../assets/logo_ricard.png"), "background": require("../assets/background_Ricard.jpg"), "background2": require("../assets/background2_Ricard.jpg")},
    {"uuid":"011ffd62-3555-44c0-b0c7-5d155d4106df", "societe":"Nike","adresse": "4 allée Centrale", "email":"nike@gmail.com", "password":"mdp123","theme":"Goodies", "description":"Parce que l’horreur n’attend pas, nous vous accompagnons avec des modèles spécialement conçus pour braver la nuit. Styles sombres, détails lumineux et confort optimal, parfaits pour parcourir les allées du festival sans crainte.","logo": require("../assets/logo_nike.png"), "background": require("../assets/background_Nike.jpeg"), "background2": require("../assets/background2_Nike.jpeg")},
    {"uuid":"86e1242d-9e72-43be-bd4c-cd763b4988d6", "societe":"Magnum","adresse": "10 rue Saint Honoré", "email":"magnum@gmail.com", "password":"mdp123","theme":"Alimentation","description":"Succombez à des douceurs glacées aux saveurs envoûtantes. Entre contrastes saisissants et textures surprenantes, nos créations spéciales Creepy Night vous réservent des sensations inédites.", "logo": require("../assets/logo_haagenDazs.png"), "background": require("../assets/background_magnum.jpg"), "background2": require("../assets/background2_magnum.jpg")},
    {"uuid":"a6859a9a-a670-4d8f-8185-0ae7c30c8f05", "societe":"Taco Bell","adresse": "9 place Montmartre", "email":"tacobell@gmail.com", "password":"mdp123","theme":"Alimentation","description":"Le piquant et l’étrange se rencontrent dans nos plats spécialement imaginés pour le festival. Une explosion de saveurs relevées, des couleurs sombres et une expérience qui réveillera les esprits… et vos papilles !", "logo": require("../assets/logo_tacoBell.png"), "background": require("../assets/background_tacoBell.jpg"), "background2": require("../assets/background2_tacoBell.jpg")},
    {"uuid":"5c3157fe-4376-441d-8cfd-0e039ee4f79b", "societe":"MicroMania","adresse": "6 avenue Opéra", "email":"micromania@gmail.com", "password":"mdp123","theme":"Goodies","description":"Plongez dans le frisson du jeu vidéo avec notre sélection spéciale d’univers terrifiants. Défis, tournois et surprises vous attendent pour une immersion totale dans le monde du gaming horrifique.", "logo": require("../assets/logo_micromania.png"), "background": require("../assets/background_microMania.jpg"), "background2": require("../assets/background2_microMania.jpg")}
];
...
let articles = [
    ...
    { "id": 6, "prestataireId": 1, "nom": 'Menu Steakhouse', "description": 'Le plaisir d\'une viande de bœuf grillée à la flamme, d\'une sauce barbecue, de bacon, des tranches de cheddar fondu et d\'oignons croustillants.', "prix": 9.99, "stock": 60, "image": require("../assets/menu_steakHouse.png")},
    ...
    { "id": 19, "prestataireId": 2, "nom": 'Figurine Pop Ca le clown', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Ca.png")},
    { "id": 20, "prestataireId": 2, "nom": 'Figurine Pop Eleven', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_11.png")},
    { "id": 21, "prestataireId": 2, "nom": 'Figurine Pop Annabelle', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Annabelle.png")},
    { "id": 22, "prestataireId": 2, "nom": 'Figurine Pop Chucky', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Chucky.png")},
    { "id": 23, "prestataireId": 2, "nom": 'Figurine Pop Vecna', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Vecna.png")},
    { "id": 24, "prestataireId": 2, "nom": 'Figurine Pop Garfield', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Garfield.png")},
    { "id": 25, "prestataireId": 2, "nom": 'Figurine Pop Demongorgon', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_demongorgon.png")},
    { "id": 26, "prestataireId": 2, "nom": 'Figurine Pop Hannibal Lecter', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Hannibal.png")},
    { "id": 27, "prestataireId": 2, "nom": 'Figurine Pop Micheal Jackson (Thriller)', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Jackson.png")},
    { "id": 28, "prestataireId": 2, "nom": 'Figurine Pop Jason Voorhees', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Jason.png")},
    { "id": 29, "prestataireId": 2, "nom": 'Figurine Pop Micheal Myers', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_MichealMyers.png")},
    { "id": 30, "prestataireId": 2, "nom": 'Figurine Pop Mr Beans', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_MrBeans.png")},
    { "id": 31, "prestataireId": 2, "nom": 'Figurine Pop La Nonne', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Nonne.png")},
    { "id": 32, "prestataireId": 2, "nom": 'Figurine Pop Jigsaw', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Saw.png")},
    { "id": 33, "prestataireId": 2, "nom": 'Figurine Pop Ghostface', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Scream.png")},
    { "id": 34, "prestataireId": 2, "nom": 'Figurine Pop Garde Squid Game', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_squidGame.png")},
    { "id": 35, "prestataireId": 2, "nom": 'Figurine Pop Mickey Magicien', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_evilMickey.png")},
    { "id": 36, "prestataireId": 2, "nom": 'Figurine Pop Mercredi', "description": "Cette figurine va vous glasser le sang attention a ne pas croiser son regard", "prix": 18.99, "stock": 10, "image": require("../assets/figurine_Adams.png")}
];
