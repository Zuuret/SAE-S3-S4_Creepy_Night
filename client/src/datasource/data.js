...
let utilisateurs = [
    {"id":'5fbd1d86-3e25-461a-be8d-bbbd9d5d94f6', "prenom":"John", "nom":"Doe", "dateNaissance":"23-09-1998", "email":"johndoe@gmail.com", "password":"mdp123", "solde": 100.00, "numCashless": 123456789},
...
let prestataires = [
    {"id":1, "societe":"Burger King","adresse": "13 rue de Japy", "email":"burgerking@gmail.com", "password":"mdp123","theme":"Alimentation", "description":"Pour le Creepy Night Festival, nous avons revisité nos classiques avec une touche effrayante ! Des recettes revisitées aux couleurs de l’horreur, des saveurs audacieuses et une ambiance qui fait frissonner. Oserez-vous y goûter ?", "logo": require("../assets/logo_burgerking.png"), "background": require("../assets/background-11111111-1111-1111-1111-111111111111.jpg"), "background2": require("../assets/background2_BK.jpg")},
...
let livre_DOr = [
    ...
    {"id": 2, "prestataireId": 1, "nomUtilisateur": "Le festifroussard", "evaluation": 4, "message": "Je me suis péter le bidon !", "date": "31 Octobre 2025"}
]
