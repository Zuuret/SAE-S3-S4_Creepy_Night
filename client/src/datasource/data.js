...
let prestataires = [
    {"id":1, "societe":"BurgerKing","adresse": "3 rue de japy", "email":"burgerking@gmail.com", "motDePasse":"mdp123","theme":"Alimentation", "description":"Pour le Creepy Night Festival, nous avons revisité nos classiques avec une touche effrayante ! Des recettes revisitées aux couleurs de l’horreur, des saveurs audacieuses et une ambiance qui fait frissonner. Oserez-vous y goûter ?", "logo": require("../assets/logo_burgerking.png"), "background": require("../assets/background_BK.jpg")},
    {"id":2, "societe":"POP","adresse": "5 rue de belfort", "email":"pop@gmail.com", "motDePasse":"mdp123","theme":"Goodies", "description":"Les icônes de l’horreur prennent vie dans notre collection spéciale Creepy Night ! Retrouvez vos personnages cultes sous forme de figurines, dans des éditions effrayantes et exclusives. Une touche de frisson à collectionner !", "logo": require("../assets/logo_pop.png"), "background": require("../assets/background_POP.jpg")},
    {"id":3, "societe":"Starbucks","adresse": "22 place République", "email":"starbucks@gmail.com", "motDePasse":"mdp123","theme":"Alimentation","description":"Plongez dans un univers ensorcelé avec nos boissons aux notes mystérieuses et envoûtantes. Entre saveurs automnales et créations surprises, chaque gorgée vous emmène dans l’ambiance inquiétante du festival.", "logo": require("../assets/logo_starbucks.png"), "background": require("../assets/background_starbucks.jpg")},
    {"id":4, "societe":"Domino's Pizza","adresse": "45 boulevard Haussmann", "email":"dominos@gmail.com", "motDePasse":"mdp123","theme":"Alimentation", "description":"Nos recettes prennent une allure terrifiante pour l’occasion ! Des ingrédients surprenants, des associations audacieuses et une touche infernale dans chaque bouchée. Préparez-vous à une expérience gustative hors du commun","logo": require("../assets/logo_domino.png"), "background": require("../assets/background_DominosPizza.jpg")},
    {"id":5, "societe":"Ricard","adresse": "8 rue du Commerce", "email":"ricard@gmail.com", "motDePasse":"mdp123","theme":"Boisson", "description":"Nos créations inédites pour le festival vous feront frissonner de plaisir. Des associations surprenantes, des couleurs sombres et un goût inimitable pour accompagner cette nuit d’épouvante","logo": require("../assets/logo_ricard.png"), "background": require("../assets/background_Ricard.jpg")},
    {"id":6, "societe":"Nike","adresse": "4 allée Centrale", "email":"nike@gmail.com", "motDePasse":"mdp123","theme":"Goodies", "description":"Parce que l’horreur n’attend pas, nous vous accompagnons avec des modèles spécialement conçus pour braver la nuit. Styles sombres, détails lumineux et confort optimal, parfaits pour parcourir les allées du festival sans crainte.","logo": require("../assets/logo_nike.png"), "background": require("../assets/background_Nike.jpeg")},
    {"id":7, "societe":"Häagen-Dazs","adresse": "10 rue Saint Honoré", "email":"haagen@gmail.com", "motDePasse":"mdp123","theme":"Alimentation","Alimentation":"alimentation","description":"Succombez à des douceurs glacées aux saveurs envoûtantes. Entre contrastes saisissants et textures surprenantes, nos créations spéciales Creepy Night vous réservent des sensations inédites.", "logo": require("../assets/logo_haagenDazs.png"), "background": require("../assets/background_HaagenDazs.jpeg")},
    {"id":8, "societe":"Taco Bell","adresse": "9 place Montmartre", "email":"tacobell@gmail.com", "motDePasse":"mdp123","theme":"Alimentation","description":"Le piquant et l’étrange se rencontrent dans nos plats spécialement imaginés pour le festival. Une explosion de saveurs relevées, des couleurs sombres et une expérience qui réveillera les esprits… et vos papilles !", "logo": require("../assets/logo_tacoBell.png"), "background": require("../assets/background_tacoBell.jpg")},
    {"id":9, "societe":"MicroMania","adresse": "6 avenue Opéra", "email":"micromania@gmail.com", "motDePasse":"mdp123","theme":"Goodies","description":"Plongez dans le frisson du jeu vidéo avec notre sélection spéciale d’univers terrifiants. Défis, tournois et surprises vous attendent pour une immersion totale dans le monde du gaming horrifique.", "logo": require("../assets/logo_micromania.png"), "background": require("../assets/background_microMania.jpg")}
];
