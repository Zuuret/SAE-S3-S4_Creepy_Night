...
INSERT INTO articles (id, prestataire_id, nom, description, prix, stock, image)
VALUES (1, '11111111-1111-1111-1111-111111111111', 'Menu Whopper',
       ...
       (3, '11111111-1111-1111-1111-111111111111', 'Menu Big King',
        'Burger avec fromage, frites et boisson',
        9.99, 735,
        'menu_bigKing.png'),
       (4, '11111111-1111-1111-1111-111111111111', 'Menu Big Fish',
        'Burger avec fromage, frites et boisson',
        7.99, 321,
        'menu_bigFish.png'),
       (5, '11111111-1111-1111-1111-111111111111', 'Menu Veggie Whopper',
        'Burger avec fromage, frites et boisson',
        6.99, 120,
        'menu_veggieWhopper.png'),
       (6, '11111111-1111-1111-1111-111111111111', 'Menu Steakhouse',
       ...
       (8, '11111111-1111-1111-1111-111111111111', 'Menu Chicken Spicy',
        'Burger avec fromage, frites et boisson',
        8.99, 20,
       ...
       (10, '11111111-1111-1111-1111-111111111111', 'Menu Cheddar Lover',
        'Burger avec fromage, frites et boisson',
        13.99, 462,
       ...
       (14, '11111111-1111-1111-1111-111111111111', 'Menu Big King XXL',
        'Burger avec fromage, frites et boisson',
        11.99, 30,
        'menu_bigKingXXL.png'),
       ...
       (17, '11111111-1111-1111-1111-111111111111',
       ...
       (19, '22222222-2222-2222-2222-222222222222',
        'Figurine Pop Ca le clown',
        'Cette figurine va vous glasser le sang attention a ne pas croiser son regard',
        18.99, 10,
        'figurine_Ca.png'),
       (20, '22222222-2222-2222-2222-222222222222', 'Figurine Pop Eleven',
        'Cette figurine va vous glasser le sang attention a ne pas croiser son regard',
        18.99, 10,
        'figurine_11.png'),
       (21, '22222222-2222-2222-2222-222222222222',
        'Figurine Pop Annabelle',
        'Cette figurine va vous glasser le sang attention a ne pas croiser son regard',
        18.99, 10,
        'figurine_Annabelle.png'),
       (22, '22222222-2222-2222-2222-222222222222', 'Figurine Pop Chucky',
        'Cette figurine va vous glasser le sang attention a ne pas croiser son regard',
        18.99, 10,
        'figurine_Chucky.png'),
       (23, '22222222-2222-2222-2222-222222222222', 'Figurine Pop Vecna',
        'Cette figurine va vous glasser le sang attention a ne pas croiser son regard',
        18.99, 10,
        'figurine_Vecna.png'),
       (24, '22222222-2222-2222-2222-222222222222',
